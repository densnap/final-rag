...
def get_llm_final_response(sql_context, rag_context, user_query):
    ...
    system_prompt = (
        ...
        "If asked about similar products provide information from the context provided of multiple other products '\n"
        ...
        "Consider SQL response as the correct and relevant context for the user query '\n"
        "If asked about similar products provide information from the context provided of other products '\n"
        + user_context
    )
